...
public class MockCrmService implements CrmService {
    List<CrmCustomer> customers = List.of(
            CrmCustomer.builder().crmCustomerId("1").firstName("John").lastName("Doe").address(CrmAddress.builder().address1("123 Main St.").city("Atlanta").state("Georgia").zipcode("30303").country("USA").build()).phoneNumber(CrmPhoneNumber.builder().phoneNumber(1231231234L).countryCode(1).build()).build(),
            CrmCustomer.builder().crmCustomerId("2").firstName("Jane").lastName("Doe").address(CrmAddress.builder().address1("456 Main St.").city("Atlanta").state("Georgia").zipcode("30303").country("USA").build()).phoneNumber(CrmPhoneNumber.builder().phoneNumber(4564564567L).countryCode(1).build()).build()
    );
