...
class CustomerServiceSpec extends Specification {
    ...
    def "should get customer by crmConfig and crmCustomer"() {
        ...
        def crmAddress = new CrmAddress("123 Main St.", null, "Atlanta", "Georgia", "30303", "USA")
        def crmPhoneNumber = new CrmPhoneNumber(1, 1231231234)
        def crmCustomer = new CrmCustomer("crm-456", null, "Jane", "Smith", crmAddress, crmPhoneNumber, "jane.s@test.com")
    ...
    def "should get list of customers by crmConfig and crmCustomers"() {
        ...
        def crmPhoneNumber = new CrmPhoneNumber(1, 1231231234)
        def crmCustomers = [
                new CrmCustomer("crm-1", null, "A", "B", crmAddress, crmPhoneNumber, "a.b@test.com"),
                new CrmCustomer("crm-2", null, "C", "D", crmAddress, crmPhoneNumber, "c.d@test.com")
        ]
