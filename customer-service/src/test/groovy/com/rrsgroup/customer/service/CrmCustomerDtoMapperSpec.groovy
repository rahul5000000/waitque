...
class CrmCustomerDtoMapperSpec extends Specification {
    ...
    def "should map list of CustomerSearchResult to CustomersSearchResultDto"() {
        ...
        def crmCustomer1 = new CrmCustomer("crm-123", null, "John", "Doe", crmAddress, crmPhoneNumber, "john.d@test.com")
        def crmCustomer2 = new CrmCustomer("crm-456", null, "Jane", "Smith", crmAddress, crmPhoneNumber, "jane.s@test.com")
